...
export const US_CITY_COORDS: Record<string, CityCoord | null> = {
  ...
  // California = alias genérico do IRG (3 warehouses reais em Brisbane/Dublin/Sacramento na Bay Area)
  California:       { lat: 37.7749, lng: -122.4194, state: 'CA', label: 'California (IRG)' },
  Ecommerce:        null,
};
